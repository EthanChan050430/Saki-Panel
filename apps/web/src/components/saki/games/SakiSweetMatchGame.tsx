          ...
          if (sa.type === "hammer") {
            ...
            setFloatTexts((prev) => [
              ...prev.slice(-4),
              {
                ...
                y: fy,
                text: "+500",
                rating: t("game.match.hammerSmash"),
                color: "#fbbf24"
              }
            ]);
          ...
          {(() => {
            const rankInfo =
              score >= 3200
                ? {
                    grade: "SSS",
                    title: t("game.match.sss.title"),
                    badgeColor: "gold",
                    expression: "/assets/expression/eating.webp",
                    quote: t("game.match.sss.quote")
                  }
                : score >= 2000
                ? {
                    grade: "S",
                    title: t("game.match.s.title"),
                    badgeColor: "pink",
                    expression: "/assets/expression/happy.webp",
                    quote: t("game.match.s.quote")
                  }
                : score >= 1000
                ? {
                    grade: "A",
                    title: t("game.match.a.title"),
                    badgeColor: "cyan",
                    expression: "/assets/expression/wink.webp",
                    quote: t("game.match.a.quote")
                  }
                : {
                    grade: "B",
                    title: t("game.match.b.title"),
                    badgeColor: "purple",
                    expression: "/assets/expression/think.webp",
                    quote: t("game.match.b.quote")
                  };
            ...
            return (
              <div className="settlement-header">
                ...
                <h3 className="settlement-title">
                  {t("game.match.settlement.complete")}
                </h3>
